...
router bgp 64020
 ...
 neighbor 10.0.3.41 update-source 10.0.3.43
 neighbor 10.0.3.42 remote-as internal
 neighbor 10.0.3.42 description SONiC42
 neighbor 10.0.3.42 update-source 10.0.3.43
 neighbor 10.0.3.44 remote-as internal
 neighbor 10.0.3.44 description SONiC44
 neighbor 10.0.3.44 update-source 10.0.3.43
 neighbor 10.0.3.45 remote-as internal
 neighbor 10.0.3.45 description SONiC45
 neighbor 10.0.3.45 update-source 10.0.3.43
 !
...
!
router ospf
 ospf router-id 10.0.3.43
 network 10.0.3.43/32 area 0.0.0.0
